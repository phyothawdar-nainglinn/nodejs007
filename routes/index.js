...
router.get('/', function(req, res, next) {
  res.render('index', { title: 'Phyo thawdar Naing Lin'});
});
...
router.post('/signup',function (req,res,next) {
  ...
  router.post('/duemail',function (req,res) {
    Admin.findOne({email:req.body.email2},function (err,rtn) {
      if(err) throw err;
      if(rtn != null || !validator.validate(req.body.email2)){
...
router.post('/passvalidate',function (req,res) {
